 ...
 * {@link UserInfo_Fragment.OnFragmentInteractionListener} interface
...
public class UserInfo_Fragment extends Fragment implements View.OnClickListener{
    ...
    private EditText editTextNomUser;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_user_info_, container, false);
        ...
        editTextNomUser = root.findViewById(R.id.editTextNomUser);

        buttonJoinSession = root.findViewById(R.id.buttonJoinSession);
        buttonJoinSession.setOnClickListener(this);
    ...
    private void joinSession() {
        ...
        String userName = editTextNomUser.getText().toString().trim();
